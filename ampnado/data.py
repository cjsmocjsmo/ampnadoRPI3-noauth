...
class Data:
	...
	def usercreds_insert_user_pword(self, a_uname, a_pword, a_hash):
		data = pymongo.MongoClient("mongodb://ampdbserv:27017/ampnadoDB").ampnadoDB
...
###############################################################################
	...
	def tags_all_thumb_size(self):
		data = pymongo.MongoClient("mongodb://ampdbserv:27017/picdb").picdb
...
###############################################################################
	...
	def viewsdb_artalpha_insert(self, x):
		data2 = pymongo.MongoClient("mongodb://ampdbserv:27017/ampviewsDB").ampviewsDB
		if version < 3:
...
###############################################################################		
	...
	def get_picid(self, x):
		data = pymongo.MongoClient("mongodb://ampdbserv:27017/ampnadoDB").ampnadoDB
		pdata = pymongo.MongoClient("mongodb://ampdbserv:27017/picdb").picdb
		if version < 3:
